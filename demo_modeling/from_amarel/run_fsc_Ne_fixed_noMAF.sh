...
cp /home/$USER/fsc26_linux64/fsc26 /home/$USER/stable_nomaf.tpl /home/$USER/stable_nomaf.est /home/$USER/stable_nomaf_MSFS.obs /home/$USER/slurm-out/$SLURM_JOBID
...
srun -N1 -n1 --cpus-per-task=28 --exclusive --mem=120000 ./fsc26 -t stable_nomaf.tpl -e stable_nomaf.est -n 100000 -m -u -M -L 40 --numBatches 28 > /home/$USER/slurm-out/$SLURM_JOBID/$SLURM_JOBID-fastsimcoal26.$SLURM_NNODES.$SLURM_NODELIST.$date.a.txt
