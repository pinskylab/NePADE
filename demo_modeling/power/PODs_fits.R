...
plot(max.mod3$X2, max.mod3$X4, xlab = '', ylab = '', type = 'n', xlim = c(1976,2008), ylim = c(0,20000), las = 1)
...
plot(max.mod5$X2, max.mod5$X4, xlab = '', ylab = '', type = 'n', xlim = c(1976,2008), ylim = c(0,26000), las = 1)
