...
#SBATCH --partition=p_deenr_1,main
#SBATCH -N1
...
mkdir -p /home/$USER/model6/slurm-out/$SLURM_JOBID
cp /home/$USER/fsc26_linux64/fsc26 /home/$USER/model6/model6.tpl /home/$USER/model6/model6.est /home/$USER/model6/model6_MSFS.obs /home/$USER/model6/slurm-out/$SLURM_JOBID
cd       /home/$USER/model6/slurm-out/$SLURM_JOBID
...
env >               /home/$USER/model6/slurm-out/$SLURM_JOBID/slurm-$SLURM_JOBID-env-all.out
env | grep SLURM >  /home/$USER/model6/slurm-out/$SLURM_JOBID/slurm-$SLURM_JOBID-env-SLURM.out
...
srun ./fsc26 -t model6.tpl -e model6.est -n 100000 -m -u -M -L 40 -0 --numBatches 1 --cores 1 > /home/$USER/model6/slurm-out/$SLURM_JOBID/$SLURM_JOBID-fastsimcoal26.$SLURM_NNODES.$SLURM_NODELIST.$date.a.txt
