...
#SBATCH --partition=main,p_eoas_1
#SBATCH -N1
...
cp /home/$USER/fsc26_linux64/fsc26 /home/$USER/model6.tpl /home/$USER/model6.est /home/$USER/model6_MSFS.obs /home/$USER/slurm-out/$SLURM_JOBID
...
srun -N1 -n1 --cpus-per-task=28 --exclusive --mem=120000 ./fsc26 -t model6.tpl -e model6.est -n 100000 -m -u -M -L 40 -0 --numBatches 28 > /home/$USER/slurm-out/$SLURM_JOBID/$SLURM_JOBID-fastsimcoal26.$SLURM_NNODES.$SLURM_NODELIST.$date.a.txt
